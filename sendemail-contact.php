...
if(isset($_POST['submit'])){
  ...
  $query = mysqli_query($conexion, "INSERT INTO clientes (nombre_cliente, telefono_cliente, proyecto_cliente, nom_negocio_cliente, descripcion_cliente, pagina_origen, fecha_contacto) VALUES ('".$nombre."', '".$telefono."', '".$selectProyectos."', '".$nom_negocio."', '".$descripcion."', '".$origenForm."', '".$fecha."')");
  ...
  try{
    ...
    $mail->isHTML(true);
    $mail->CharSet = 'UTF-8';
    $mail->Subject = 'Página GalletaMKT cotización de '.$selectProyectos;
    $mail->Body = "<h3>Nombre : $nombre <br>Teléfono: $telefono <br>Proyecto : $selectProyectos <br>Descripción del proyecto : $descripcion </h3>";
